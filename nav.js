...
function ShowSelection() {
  ...
  switch (selectedValue) {
      case 'karthik':
        ...
        <span class="title">Sustainable management of Biomedical Waste under current circumstances</span>
        <br>
        <span class="author">Author: <a href="#" style="color: green;">Dr. Sumanta Bhattacharya</a>, <a href="#" style="color: green;">Arkaduti Seth</a></span>
        <br>
        <a class="link" href="#">View Paper</a>
